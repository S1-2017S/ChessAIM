			...
			for(var ligne = 0; ligne < 8; ligne ++) {
				...
				for(var colonne = 0; colonne < 8; colonne ++) {
					...
					if (liste_board[h_new][v] === liste_board[ligne][colonne] && liste_board[h_new][v] === " ") {
						marqueurs_board["sqr_"+ ligne +":"+ colonne] = "<a href='req_placement?pseudo="+query.pseudo+"&x="+ h +"&y="+ v +"&x_new="+ h_new + "&y_new="+ v +"'><img src="+ liste_images[pawn] +"></a>";
					} else if (liste_board[h_new][v_new] === liste_board[ligne][colonne] && liste_board[h_new][v_new] === liste_board[h_new][v_new].toUpperCase()) {                    marqueurs_board["sqr_"+ ligne +":"+ colonne] = "<a href='req_placement?pseudo="+query.pseudo+"&x="+ h +"&y="+ v +"&x_new="+ h_new + "&y_new="+ v_new +"'><img src="+ liste_images[pawn] +"></a>";
					} else if (liste_board[h_new][v_new2] === liste_board[ligne][colonne] && liste_board[h_new][v_new2] === liste_board[h_new][v_new2].toUpperCase()) {
						marqueurs_board["sqr_"+ ligne +":"+ colonne] = "<a href='req_placement?pseudo="+query.pseudo+"&x="+ h +"&y="+ v +"&x_new="+ h_new + "&y_new="+ v_new2 +"'><img src="+ liste_images[pawn] +"></a>";
					} else {
						marqueurs_board["sqr_"+ ligne + ":"+ colonne] = "<img src="+ liste_images[pawn] +"></a>";
					}
				}
