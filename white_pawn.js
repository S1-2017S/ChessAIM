		...
		if (v_new < 8 && v_new2 > -1 && h_new > -1) {
			...
			for(var ligne = 0; ligne < 8; ligne ++) {
				...
				for(var colonne = 0; colonne < 8; colonne ++) {
					...
					} else if (liste_board[h_new][v_new] === liste_board[ligne][colonne] && liste_board[h_new][v_new] === liste_board[h_new][v_new].toUpperCase()) {
					
					marqueurs_board["sqr_"+ ligne +":"+ colonne] = "<a href='req_placement?pseudo="+query.pseudo+"&x="+ h +"&y="+ v +"&x_new="+ h_new + "&y_new="+ v_new +"'><img src="+ liste_images[pawn] +"></a>";
