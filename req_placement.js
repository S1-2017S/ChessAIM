...
var trait = function(req, res, query) {
	...
	if(liste_board[query.x][query.y] === "r" && liste_board[query.x_new][query.y_new] === "k") {
	...
	}else if (liste_board[query.x][query.y] === liste_board[query.x][query.y].toLowerCase() && liste_board[query.x_new][query.y_new] === "K") {

		console.log(liste_board[query.x][query.y]);
	...
	} else if (liste_board[query.x][query.y] === liste_board[query.x][query.y].toUpperCase() && liste_board[query.x_new][query.y_new] === "k") {
		...
		marqueurs = {};
		marqueurs.pseudo = query.pseudo;
		marqueurs.vaiqueur = query.pseudo;
		page = page.supplant(marqueurs);
